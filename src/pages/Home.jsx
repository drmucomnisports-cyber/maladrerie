        ...
        <div className="max-w-7xl mx-auto py-12 relative z-10">
          <div className="flex flex-col items-center mb-16 text-center max-w-4xl mx-auto" data-reveal="top">
            ...
            <p className="text-xl text-blue-100 font-medium leading-relaxed">
              Nous proposons des séjours et stages clé en main, conçus en partenariat avec des associations locales spécialisées dans les activités de pleine nature. Chaque projet peut être construit sur mesure afin de s'adapter aux objectifs pédagogiques, aux publics et aux contraintes des groupes accueillis.
            </p>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-md p-10 rounded-[2.5rem] border-t-8 border-muc-yellow hover-lift shadow-2xl" data-reveal="left">
              ...
              <ul className="space-y-8 text-lg">
                <li className="flex items-center gap-5 group">
                  ...
                  <span className="font-medium tracking-tight"><strong>Canoë-kayak</strong> : location et descentes sur le Tarn</span>
                </li>
                <li className="flex items-center gap-5 group">
                  <div className="bg-muc-yellow p-1.5 rounded-lg transform group-hover:rotate-12 transition-transform">
                    <CheckCircle2 className="text-muc-blue" size={20} />
                  </div>
                  <span className="font-medium tracking-tight"><strong>Escalade & Via Ferrata</strong> : sites naturels d'exception</span>
                </li>
                <li className="flex items-center gap-5 group">
                  <div className="bg-muc-yellow p-1.5 rounded-lg transform group-hover:rotate-12 transition-transform">
                    <Compass className="text-muc-blue" size={20} />
                  </div>
                  <span className="font-medium tracking-tight"><strong>Spéléologie & Parapente</strong> : l'aventure totale</span>
                </li>
                <li className="flex items-center gap-5 group">
                  <div className="bg-muc-yellow p-1.5 rounded-lg transform group-hover:rotate-12 transition-transform">

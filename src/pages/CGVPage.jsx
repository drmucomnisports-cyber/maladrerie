...
const CGVPage = () => {
  return (
    <div className="min-h-screen bg-[#004B93] text-white py-20 px-6">
      <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-xl p-10 rounded-[2.5rem] border border-white/10 shadow-2xl">
        ...
        <div className="space-y-12 text-white/80 leading-relaxed text-sm">
          ...
          <section>
            ...
            <p>En cas de demande de modification de la part du client, les conditions suivantes s'appliquent :</p>
            <ul className="mt-4 space-y-2 list-disc list-inside">
          ...
          <section>
            ...
            <ul className="mt-4 space-y-2 list-disc list-inside">
              ...
              <li><strong>Modalités de commande :</strong> les commandes de repas doivent être impérativement transmises et validées au plus tard le jeudi pour la semaine suivante. Passé ce délai, aucune commande ne pourra être enregistrée sur l'espace de réservation.</li>
